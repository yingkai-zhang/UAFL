...
from ..qrnn3d.layer import QRNNConv3D, QRNNDeConv3D, QRNNUpsampleConv3d, BiQRNNDeConv3D, BiQRNNConv3D, BiQRNNUpsampleConv3d
# from ..qrnn3d.layer2 import QRNNConv3D, QRNNDeConv3D, QRNNUpsampleConv3d, BiQRNNDeConv3D, BiQRNNConv3D
...
#         # self.layers.append(QRNNUpsampleConv3d(32+32+64, 16, bn=bn, act=act))
#         # wo qrnn
#         self.layers.append(BiQRNNUpsampleConv3d(128+64, 64, bn=bn, act=act))
#         self.layers.append(BiQRNNUpsampleConv3d(64+64+64, 32, bn=bn, act=act))
#         self.layers.append(BiQRNNUpsampleConv3d(32+32+64, 16, bn=bn, act=act))

#         self.reconstructor = BiQRNNDeConv3D(16+16+64, 1, bias=True, bn=bn, act=act)
#         # wo biqrnn
#         # self.reconstructor = QRNNDeConv3D(16+16+64, 1, bn=bn, act=act)
...
#         tmp = t.unsqueeze(2).expand(t.shape[0], t.shape[1], BAND, t.shape[2], t.shape[3])
#         x = torch.cat([x, hsi_feats[-4], tmp], dim=1)
#         # x = self.reconstructor(x, reverse)
#         # wo qrnn
#         x = self.reconstructor(x)
#         return x
