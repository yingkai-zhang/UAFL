...
class BNReLUConv3d(nn.Sequential):
    def __init__(self, in_channels, channels, k=3, s=1, p=1, inplace=False):
        ...
        # self.add_module('conv', nn.Conv3d(in_channels, channels, k, s, p, bias=False, groups=3))
...
class BNReLUDeConv3d(nn.Sequential):
    def __init__(self, in_channels, channels, k=3, s=1, p=1, inplace=False):
        ...
        # self.add_module('deconv', nn.ConvTranspose3d(in_channels, channels, k, s, p, bias=False, groups=3))
...
class UpsampleConv3d(torch.nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding, bias=True, upsample=None):
        ...
        # self.conv3d = torch.nn.Conv3d(in_channels, out_channels, kernel_size, stride, padding, bias=bias, groups=3)
...
class BasicConv3d(nn.Sequential):
    def __init__(self, in_channels, channels, k=3, s=1, p=1, bias=False, bn=True):
        ...
        # self.add_module('conv', nn.Conv3d(in_channels, channels, k, s, p, bias=bias, groups=3))
...
class BasicDeConv3d(nn.Sequential):
    def __init__(self, in_channels, channels, k=3, s=1, p=1, bias=False, bn=True):
        ...
        # self.add_module('deconv', nn.ConvTranspose3d(in_channels, channels, k, s, p, bias=bias, groups=3))
