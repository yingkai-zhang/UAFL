...
from .utils import bilinear_sampler, coords_grid, upflow8, InputPadder
...
class RAFT(nn.Module):
    ...
    def forward(self, image1, image2, iters=12, flow_init=None, upsample=True, test_mode=False):
        ...
        output_dic = {
                    'flow_12_1':F.interpolate(flow_predictions[-1], size=(H, W), mode='bilinear', align_corners=False),
                    'flow_12_2':F.interpolate(flow_predictions[-1], size=(H//2, W//2), mode='bilinear', align_corners=False),
                    'flow_12_3':F.interpolate(flow_predictions[-1], size=(H//4, W//4), mode='bilinear', align_corners=False),
                    'flow_12_4':F.interpolate(flow_predictions[-1], size=(H//8, W//8), mode='bilinear', align_corners=False)
                 }
        return output_dic
